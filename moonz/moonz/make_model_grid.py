...
def make_model_grid():
    n_train = 100000
    max_redshift = 5.5  # Controls the minimum wavelength the models go to.

    dblplaw = {}
    dblplaw["massformed"] = 1.
    dblplaw["metallicity"] = 1.#(0.2, 2.5)
    ...
    prior = pipes.fitting.check_priors(fit_instructions,
                                       spec_wavs=pc_wavs, n_draws=n_train)
    ...
    if os.path.exists("model_grid.fits"):
        os.system("rm model_grid.fits")

    hdulist.writeto("model_grid.fits")
